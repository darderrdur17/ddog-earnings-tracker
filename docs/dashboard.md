...
3. **Intra-quarter stub strip** — npm package YoY through the latest settled day (2026-09-06, 68/92 days). Labeled **coincident** — not a revenue forecast.
...
- The **stub** (+143% package YoY) is a same-quarter download update, not a revenue call.
